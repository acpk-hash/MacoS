    ...
    <div className="flex flex-col h-full border-l border-line bg-surface/30 overflow-hidden" style={{ minWidth: '300px', maxWidth: '380px', width: '340px' }}>
      ...
      <div className="flex-1 overflow-y-auto px-3 py-3 space-y-3">
        ...
        <div className="flex items-center gap-2">
          ...
          {saveMsg && <span className={'text-[11px] ' + (saveMsg.startsWith('保存失败') ? 'text-failed' : 'text-success')}>{saveMsg}</span>}
        </div>
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0">
      ...
      {store.notice && !store.error && (
        <div className="px-4 py-2 text-[12px] text-success border-b border-line/60 flex items-center gap-2">
